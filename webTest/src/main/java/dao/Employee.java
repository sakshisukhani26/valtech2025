...
public class Employee implements Comparable<Employee>{
	...
	public Employee(int id,String name,int age,float salary,Gender gender,int level,int experience,int dept_id) {
		super();
		this.id= id;
		this.name=name;
		this.age=age;
	...
	@Override
	public int hashCode() {
		return Objects.hash(age, dept_id, experience, gender, id, level, name, salary);
	}
...
//	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Employee other = (Employee) obj;
		return age == other.age && dept_id == other.dept_id && experience == other.experience && gender == other.gender
