...
insert into author (id,name,address) values(nextval('author_seq'),'James Gosling','US');
...
insert into author (id,name,address) values(nextval('author_seq'),'Khalid Hosseini','Afghanistan');
